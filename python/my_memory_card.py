...
questions_list = []
questions_list.append(Question('The state language of Brasil', 'Portuguese', 'English', 'Spanish', 'Brazilian'))
questions_list.append(Question('Which colour does not appear on the American flag?', 'Red', 'Green', 'White', 'Blue'))
